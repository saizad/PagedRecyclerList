...
public class CountDrawable extends Drawable {
    ...
    public CountDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.menu_circle_badge);
    ...
    public static void setCount(Context context, Drawable drawable, int count) {
        ...
        icon.mutate();
        icon.setDrawableByLayerId(R.id.badge_count, badge);
    }
}